		...
		>
			...
			>
				{mainListItems.map((item, index) => (
					...
					>
						<ListItemButton
							selected={index === ['Combat', 'Characters', 'Maps', 'Notes', 'Search', 'Settings', 'About'].indexOf(tab)}
			...
			>
				{secondaryListItems.map((item, index) => (
					...
					>
						<ListItemButton
							selected={index === ['Combat', 'Characters', 'Maps', 'Notes', 'Search', 'Settings', 'About'].indexOf(tab) - 5}
							onClick={() => setTab(item.text)}
						>
							<ListItemIcon>
								{item.icon}
