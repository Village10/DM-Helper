...
export default function NewButton({ setSelected, newCombatant, combatants }) {
	...
	return (
		<>
			...
			>
				<MenuItem
					onClick={() => {setOpenDrop(false); setOpenNew(true)}}
				>
					From Text
				</MenuItem>
				<MenuItem
					onClick={() => {setOpenDrop(false); setOpenSaved(true); setSaveChecked([])}}
				>
					From Save
				</MenuItem>
				<MenuItem
					onClick={() => {setOpenDrop(false); setOpenCharacter(true); setSaveChecked([])}}
				>
					From Character
				</MenuItem>
				<MenuItem
					onClick={() => {setOpenDrop(false); setOpenMonster(true); setSaveChecked([])}}
				>
					From Monster
				</MenuItem>
			</Menu>
