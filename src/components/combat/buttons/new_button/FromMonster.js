...
import {toStorable} from "../../../../util/misc";
...
export default function FromMonster({setSelected, saveChecked, setSaveChecked, setOpenMonster, openMonster, combatants, newCombatant}) {
    return (
        <Dialog open={openMonster} onClose={() => setOpenMonster(false)}
        ...
        >
            <DialogTitle>New Combatant(s) From Monster(s)</DialogTitle>
            <DialogContent>
                <FormGroup>
            ...
            <DialogActions>
                <Button onClick={() => {setOpenMonster(false); setSaveChecked([])}}>Cancel</Button>
