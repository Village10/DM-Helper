				...
				<DialogContent>
					...
					>
						<TextField
							...
							variant='standard'
							defaultValue={selected ? selected.level: null}
						/>
						<TextField
							autoFocus
							required
							...
							InputProps={{ inputProps: { min: 1 } }}
							variant='standard'
							defaultValue={selected ? selected.maxHealth: null}
						/>
						<TextField
							autoFocus
							required
					...
					<TextField
						...
						fullWidth
						variant='standard'
						defaultValue={selected ? selected.mainClass: null}
					/>
					<TextField
						autoFocus
						required
						...
						fullWidth
						variant='standard'
						defaultValue={selected ? selected.subClass: null}
					/>
					<TextField
						autoFocus
						required
						...
						fullWidth
						variant='standard'
						defaultValue={selected ? selected.species: null}
					/>
					<TextField
						autoFocus
						required
						...
						fullWidth
						variant='standard'
						defaultValue={selected ? selected.background: null}
					/>
				</DialogContent>
				<DialogActions>
					<Button
